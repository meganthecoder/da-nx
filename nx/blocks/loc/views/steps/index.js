...
function basics({ view, org, site }) {
  const step = {
    visible: VIEW_TYPES[view] === 'setup',
    style: true,
    icon: '#S2_Icon_ListBulleted_20_N',
    text: 'Setup basics',
  };
...
export function calculateView(currentView, dir, project) {
  return VIEWS[currentView](project)[dir];
}
